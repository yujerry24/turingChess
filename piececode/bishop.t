...
if teamNumber = 10 then
    if pieceArray (ypos, xpos) = 14 then
	result pieceArray
    end if
    for value1 : 1 .. 7
	v1 := value1 + xpos
	...
	if v3 <= 8 and v3 >= 1 and v1 <= 8 and v1 >= 1 then
	    ...
	    elsif pieceArray (ypos + value1, xpos + value1) = 14 and BRDW = true then
	...
	if v3 <= 8 and v3 >= 1 and v2 <= 8 and v2 >= 1 then
	    ...
	    elsif pieceArray (ypos + value1, xpos - value1) = 14 and BLDW = true then
		returnArray (ypos + value1, xpos - value1) := 30
		returnArray (ypos, xpos) := 14
		pieceFound := true
		result returnArray
	...
	if v4 <= 8 and v4 >= 1 and v1 <= 8 and v1 >= 1 then
	    ...
	    elsif pieceArray (ypos - value1, xpos + value1) = 14 and TLDW = true then
		returnArray (ypos - value1, xpos + value1) := 30
		returnArray (ypos, xpos) := 14
		pieceFound := true
		result returnArray
	...
	if v4 <= 8 and v4 >= 1 and v2 <= 8 and v2 >= 1 then
	    ...
	    elsif pieceArray (ypos - value1, xpos - value1) = 14 and TRDW = true then
		returnArray (ypos - value1, xpos - value1) := 30
		returnArray (ypos, xpos) := 14
		pieceFound := true
		result returnArray
...
if teamNumber = 20 then
    if pieceArray (ypos, xpos) = 24 then
	result pieceArray
    end if
    for value2 : 1 .. 7
	v5 := value2 + xpos
	...
	if v7 <= 8 and v7 >= 1 and v5 <= 8 and v5 >= 1 then
	    ...
	    elsif pieceArray (ypos + value2, xpos + value2) = 24 and BRDB = true then
	...
	if v7 <= 8 and v7 >= 1 and v6 <= 8 and v6 >= 1 then
	    ...
	    elsif pieceArray (ypos + value2, xpos - value2) = 24 and BLDB = true then
		returnArray (ypos + value2, xpos - value2) := 30
		returnArray (ypos, xpos) := 24
		pieceFound := true
		result returnArray
	...
	if v8 <= 8 and v8 >= 1 and v5 <= 8 and v5 >= 1 then
	    ...
	    elsif pieceArray (ypos - value2, xpos + value2) = 24 and TLDB = true then
		returnArray (ypos - value2, xpos + value2) := 30
		returnArray (ypos, xpos) := 24
		pieceFound := true
		result returnArray
